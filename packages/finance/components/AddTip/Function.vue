  ...
  <form class="form-widget px-5" @submit.prevent="postTips">
    ...
    <div>
      <div>
        ...
        <input id="beer_sales" type="number" step=".01" v-model="beer_sales_input" />
      </div>
      <div>
        <label for="food_sales">Food Sales</label>
        <input id="food_sales" type="number" step=".01" v-model="food_sales_input" />
      </div>
      <div>
        <label for="liquor_sales">Liquor Sales</label>
        <input id="liquor_sales" type="number" step=".01" v-model="liquor_sales_input" />
      </div>
      <div>
        <label for="wine_sales">Wine Sales</label>
        <input id="wine_sales" type="number" step=".01" v-model="wine_sales_input" />
      </div>
      <div>
        <label for="retail_sales">Retail Sales</label>
        <input id="retail_sales" type="number" step=".01" v-model="retail_sales_input" />
      </div>
    </div>
    <!-- PPA -->
    <div>
