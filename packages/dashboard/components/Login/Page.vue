            ...
            <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
                ...
                <div>
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email
                        address</label>
                    <div class="mt-2">
                        <LibInputText id="email" type="text" v-model="email" placeholder="Email Address" />
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <LibInputPassword id="password" type="password" v-model="password" placeholder="Password"
                ...
                <div>
                    <button type="submit" @click="signInAuth"
