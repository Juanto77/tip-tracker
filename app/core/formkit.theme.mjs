/**
  ...
  *
  * @checksum - 1abf1954320abf34a4ebf55ecd4d1cc94b4b82a71e649e4f852aeca4937d40da
  * @variables - radius=rounded-none,accentColor=blue,colorTemperature=neutral,spacing=1.5,scale=base,inputShadow=shadow-md,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes = {
  ...
  "file__inner": {
    "relative": true,
    "cursor-pointer": true,
    "group-data-[has-multiple]:rounded-none": true
  },
  "file__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "datepicker__openButton": {
    ...
    "focus-visible:ring-blue-400": true,
    "focus-visible:ring-offset-2": true,
    "focus-visible:rounded-none": true
  },
