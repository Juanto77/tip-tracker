      ...
      <div class="py-3">
        ...
        <div>
          <UFormGroup label="Cash Tips" class="py-3">
            <UInput type="number" name="cash-tips" />
          </UFormGroup>
          <UFormGroup label="Credit Tips" class="py-3">
            <UInput type="number" name="credit-tips" />
          </UFormGroup>
        </div>
      </div>
      <!-- /Income -->
      ...
      <div>
        ...
        <div>
          <UFormGroup label="Food Sales" class="py-3">
            <UInput type="number" name="food-sales" />
          </UFormGroup>
          <UFormGroup label="Beer Sales" class="py-3">
            <UInput type="number" name="beer-sales" />
          </UFormGroup>
          <UFormGroup label="Liquor Sales" class="py-3">
            <UInput type="number" name="liquor-sales" />
          </UFormGroup>
          <UFormGroup label="Wine Sales" class="py-3">
            <UInput type="number" name="wine-sales" />
          </UFormGroup>
          <UFormGroup label="Retail Sales" class="py-3">
            <UInput type="number" name="retail-sales" />
          </UFormGroup>
        </div>
      </div>
      <!-- /Sales -->
