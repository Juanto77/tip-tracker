            ...
            <template #content>
                <form class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            <label for="username"
                                class="block text-sm font-medium leading-6 text-black">Username</label>
                            <div class="mt-2">
                                <div
...
/*
if (props.userData) {
    fName = props.userData.first_name
    lName = props.userData.last_name
    email = props.userData.email
    username = props.userData.username;
    website = props.userData.website;
    avatar_path = props.userData.avatar_url;
}
*/
