...
// import data from '~/assets/import/raw-tip-aug.json' // Tip Data up to August 5th
import data from '~/assets/import/raw-tip-2023.json' // Tip Data from 2023
...
<template>
    <div>
        <button @click="callOnce">CALL ONCE</button>
    </div>
</template>